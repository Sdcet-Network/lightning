...
from lightning.dispatcher.logging import configure_logging
...
@click.group()
def main():
    """闪电（lightning） - Fact-graph based collaborative exploration protocol."""
...
def dispatch(config_path: Path, once: bool, startup_healthcheck_only: bool, log_level: str):
    """Run the 闪电（lightning） dispatcher."""
