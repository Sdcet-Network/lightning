...
from lightning.dispatcher.workers.adapters import ClaudeCodeDriver, CodexDriver, MockDriver, PiDriver
from lightning.dispatcher.workers.base import WorkerDriver
...
# Local variants invoke the host CLIs in their native configuration (no lightning provider
