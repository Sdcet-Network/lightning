...
from lightning.dispatcher.config import DispatchConfig, WorkerConfig
...
def project_allows_conclude_fallback(client: LightningClient, project_id: str, *, worker_name: str, intent_id: str) -> bool:
...
def best_effort_release_reason(client: LightningClient, project_id: str, worker_name: str) -> None:
...
def best_effort_release(client: LightningClient, project_id: str, intent_id: str, worker_name: str) -> None:
