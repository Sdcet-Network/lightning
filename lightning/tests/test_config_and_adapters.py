...
from lightning.dispatcher.config import DispatchConfig, WorkerConfig, validate_prompt_resources
...
def test_pi_driver_models_json_and_execute_argv_include_context_window_and_tools() -> None:
    ...
    assert models["providers"]["lightning"]["models"][0]["contextWindow"] == 131072
...
def test_codex_driver_execute_argv_passes_model_endpoint_and_prompt() -> None:
    ...
    assert 'model_providers.lightning.base_url="http://api/v1"' in argv
